...
<div style="display: flex;align-items: center;height: 80vh; min-block-size: 480px;" :key="conRender">
...
<div class="funds-success-message-container">
  <div class="funds-checkmark-text-container">
    ...
    <h1 class="funds-success-done-text">Compte vérifié !</h1>
  </div>
  ...
  <div class="funds-success-message">
   ...
   <p >Bienvenu chez AtypikHouse!</p>
  </div>


  <div style="width: 100%;display: flex;flex-direction: column;justify-content: center;align-items: center;height: 200px;">
      <router-link

                      style="text-decoration: none"
                      to="/se-connecter"
                      class="text-dark"
                      ><button style="background-color: black;color: white;padding: 15px 50px;border-radius: 47px;">Se connecter</button>
      </router-link>
  </div>
